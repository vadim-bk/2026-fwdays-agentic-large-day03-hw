...
- **Can be invoked anytime**: This workflow can run before all artifacts are done (if tasks exist), after partial implementation, or interleaved with other actions.
